...
Cette version inclue aussi [la pull request](https://github.com/LAB-MI/attestation-deplacement-derogatoire-q4-2020/pull/58) de [tar-gezed](https://github.com/tar-gezed) pour l'enregistrement automatique des données.
